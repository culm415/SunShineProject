...
#define TEXTURE_WIDTH_LOGO			(500)			// ロゴサイズ
...
void DrawResult(void)
{
	...
	// リザルトを描画
	{
		...
		// １枚のポリゴンの頂点とテクスチャ座標を設定
		SetSprite(g_VertexBuffer, g_Pos.x, 200.0f, TEXTURE_WIDTH_LOGO, TEXTURE_HEIGHT_LOGO, 100.0f, 10.0f, 1.0f, 1.0f);
